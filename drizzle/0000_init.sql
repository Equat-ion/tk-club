...
ALTER TABLE "user_settings" ADD CONSTRAINT "user_settings_organizer_id_users_id_fk" FOREIGN KEY ("organizer_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;